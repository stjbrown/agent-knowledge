...
```text
artifacts/stjbrown-agent-knowledge-0.1.0-beta.4.tgz
```
...
```bash
git rev-parse HEAD
shasum -a 256 artifacts/stjbrown-agent-knowledge-0.1.0-beta.4.tgz
git status --short
```
...
npm install \
  ...
  /path/to/stjbrown-agent-knowledge-0.1.0-beta.4.tgz
